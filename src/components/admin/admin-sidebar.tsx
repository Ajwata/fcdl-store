    ...
    >
      ...
      <div className="space-y-0.5 border-t border-white/10 px-3 py-4">
        <Link
          href="/"
          target="_blank"
          className="flex items-center gap-2.5 rounded-xl border border-white/25 bg-white px-3 py-2.5 text-sm font-semibold text-[var(--blue-900)] shadow-sm transition hover:bg-[var(--blue-50)]"
        >
          <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
